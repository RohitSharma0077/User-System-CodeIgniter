...
?>
        <div class="alert alert-info">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
            <strong><?php echo $this->session->flashdata('logout_success'); ?></strong>
        </div>
...
?>
        <div class="alert alert-info">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">×</a>
            <strong><?php echo $this->session->flashdata('registration'); ?></strong>
        </div>
 ...
 <div class="row">
  ...
  <form class="form-horizontal" action="<?php echo base_url(); ?>admin_ctrl/test_fun_insert" method="post">
    <fieldset>
    ...
    <div style="display: inline-flex;">
      ...
      <form action="<?php echo base_url(); ?>admin_ctrl/loginform" method="post" style="border:none;">

        <button type="submit" style="background: transparent;  color:black; margin-left: 120px;">Login Here</button>

      </form>
      <span style="margin-top: 4px; margin-left: 20px">Registered User ?</span>
