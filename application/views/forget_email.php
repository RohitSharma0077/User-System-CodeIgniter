     ...
     <div class="row">
      <div class="well col-md-5 center login-box">
       <div class="alert alert-info">
        Confirm Email before you proceed
       </div>
       <form class="form-horizontal" action="<?php echo base_url(); ?>admin_ctrl/test_fun_forgetmail_chk" method="post">
        <fieldset>
       ...
       <!--   <div class="input-prepend">
          ...
          <form action="<?php echo base_url(); ?>Test_ctrl/mailconfirm" method="post" style="border:none;">
